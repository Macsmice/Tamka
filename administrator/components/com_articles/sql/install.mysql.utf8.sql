...
(1, 0, 0, 1, 'com_articles', 'com_articles', '{"core.admin":{"7":1},"core.manage":{"6":1},"core.create":{"3":1},"core.delete":[],"core.edit":{"4":1},"core.edit.state":{"5":1},"core.edit.own":[]}');
...
INSERT INTO `#__assets` (`level`, `name`, `title`, `rules`)
    SELECT 2 as `level`, CONCAT('com_articles.category', '.', id) as `name`, title as `title`, '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}' as `rules`
     FROM `#__categories`
...
INSERT INTO `#__assets` (`level`, `name`, `title`, `rules`)
    SELECT 3 as `level`, CONCAT('com_articles.article', '.', id) as `name`, title as `title`, '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}' as `rules`
     FROM `#__articles`;
