...
7. add fields like things or tags... (Do it)
...
Things Manager Page - Multiple View - List
...
2. To change the Title Text: Update the Language String for COM_THINGS_MANAGER_THINGS (How? *)
...
4. To change the Title Image: Replace the media/com_things/images/icon-48-things.png file
