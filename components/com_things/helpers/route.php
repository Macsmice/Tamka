...
class ThingsRouteHelper
{
	 ...
	 * @var		string
	 */
	public $componentOptionParam = 'com_things';
     ...
     * @return string
     */
	public function getThingRoute ($id, $catid, $data)
    {
