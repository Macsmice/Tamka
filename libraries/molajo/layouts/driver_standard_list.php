...
foreach ($this->recordset as $this->row) {
    ...
    if (file_exists($this->layoutFolder.'/layouts/item_header.php')) {
        include $this->layoutFolder.'/layouts/item_header.php';
    }
    ...
    if (file_exists($this->layoutFolder.'/layouts/item_body.php')) {
        include $this->layoutFolder.'/layouts/item_body.php';
    }

    if (file_exists($this->layoutFolder.'/layouts/item_footer.php')) {
        include $this->layoutFolder.'/layouts/item_footer.php';
    }
}
