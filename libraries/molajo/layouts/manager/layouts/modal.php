	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th width="15%">
					<?php echo JHtml::_('grid.sort',  'JGRID_HEADING_ACCESS', 'access_level', $this->listDirn, $this->listOrder); ?>
				</th>
				<th width="15%">
				...
				<th width="5%">
					<?php echo JHtml::_('grid.sort',  'JDATE', 'a.created', $this->listDirn, $this->listOrder); ?>
				</th>
