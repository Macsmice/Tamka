...
<?php if (count($this->children[$this->category->id]) > 0) : ?>
	...
	<?php foreach($this->children[$this->category->id] as $id => $child) : ?>
		<?php
		if ($this->state->get('show_empty_categories') || $child->getNumItems(true) || count($child->getChildren())) :
		...
		<li<?php echo $class; ?>>
			...
			<?php if ($this->state->get('show_subcat_desc') == 1) :?>
			...
			<?php endif; ?>
			<?php endif; ?>
			<?php if ( $this->state->get('show_cat_num_articles',1)) : ?>
			<dl>
				<dt>
