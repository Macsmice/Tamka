...
if ($this->render['column_name'] == 'title' && $this->state->def('config_manager_grid_column_display_alias', 1)) {
...
<?php if ($this->row->checked_out) : ?>
        <?php echo JHtml::_('jgrid.checkedout', $this->rowCount, $this->row->editor, $this->row->checked_out_time, $defaultView.'.', $this->row->canCheckin); ?>
<?php endif; ?>
...
<?php if ($this->state->def('config_manager_grid_column_display_alias', 1))  : ?>
